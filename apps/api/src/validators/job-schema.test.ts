...
describe('createJobSchema', () => {
  ...
  describe('transformations validation', () => {
    ...
    it('should reject width below minimum (0)', () => {
      ...
      expect(error).toBeDefined();
      expect(error?.message).toContain('"transformations.width" must be greater than or equal to 1');
    });
    ...
    it('should reject width above maximum (4001)', () => {
      ...
      expect(error).toBeDefined();
      expect(error?.message).toContain('"transformations.width" must be less than or equal to 4000');
    });
    ...
    it('should reject non-integer width', () => {
      ...
      expect(error).toBeDefined();
      expect(error?.message).toContain('"transformations.width" must be an integer');
    });
