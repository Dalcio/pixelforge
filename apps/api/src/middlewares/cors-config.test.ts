...
describe("CORS Configuration", () => {
  ...
  describe("Multiple origins configuration", () => {
    it("should allow multiple configured origins", async () => {
      const app = createTestApp("http://localhost:5173,https://example.com,https://app.example.com");
      ...
      expect(response3.headers["access-control-allow-origin"]).toBe("https://app.example.com");
    });
  ...
  describe("Production scenarios", () => {
    it("should allow localhost:5173 and production domain", async () => {
      const app = createTestApp("http://localhost:5173,https://pixelforge.example.com");
